...
CREATE TABLE password_parameters (
  id BINARY(16) NOT NULL,
...
CREATE TABLE app_user (
  ...
  password_parameters_id BINARY(16) NOT NULL,
  ...
  CONSTRAINT "069e1f68-bede-16c9-0000-ee68688a668b" FOREIGN KEY (password_parameters_id) REFERENCES password_parameters (id),
