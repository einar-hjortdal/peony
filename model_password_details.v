...
struct PasswordDetailsGetParams {
	hash []u8
	id   ?ID
}

fn model_password_details_get(mut tx firebird.Transaction, p PasswordDetailsGetParams) !PasswordDetails {
...
fn model_password_details_create(mut tx firebird.Transaction, id ID, function_name string, parameters string, hash []u8) ! {
