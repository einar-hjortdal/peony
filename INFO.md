...
The higher layer is called `conduit`. Because this layer orchestrates database operations, it also has the task of validating request inputs, when such validation requires access to the database.

The lower level is called `record`.
