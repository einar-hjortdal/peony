...
pub fn locale_list(mut tx firebird.Transaction, p record.LocaleRetrieveParams) ![]record.Locale {
...
fn conduit_locale_get(mut tx firebird.Transaction, locale_id record.ID) !record.Locale {
