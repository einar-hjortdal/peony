...
pub fn sales_channel_update(mut tx firebird.Transaction, sales_channel_id ID, p record.SalesChannelUpdateParams) ! {
	record.sales_channel_update(mut tx, sales_channel_id, p) or {
		return new_error_internal('Could not create sales_channel', err.msg())
	}
}

pub fn sales_channel_get(mut tx firebird.Transaction, sales_channel_id ID) !record.SalesChannel {
