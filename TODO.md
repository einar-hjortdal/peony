...
- [x] Database setup and migrations should be triggered manually, not by startup
...
- [ ] Email services validate addresses differently, consider adding an optional email validation function field to Config.
