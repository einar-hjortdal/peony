...
fn conduit_user_create(mut app App, mut ctx Context, p UserCreateRequest) veb.Result {
	...
	password_parameters := model_password_parameters_get(mut tx, PasswordParametersGetParams{
		...
		model_password_parameters_create(mut tx, password_parameters_id,
		...
		model_password_parameters_get(mut tx, PasswordParametersGetParams{
			hash: password_parameters_hash
		}) or {
			tx.rollback() or {}
	...
	model_user_create(mut tx, UserCreateParams{
		...
		password_parameters_id: password_parameters.id
